package com.appsforlife.mynotes.constants;
...
public final class Constants {
    ...
    public static final String QUICK_ACTIONS_TYPE = "quickActionsType";
    public static final String IMAGE_PATH = "imagePath";
    public static final String CAMERA_PATH = "imagePath";
